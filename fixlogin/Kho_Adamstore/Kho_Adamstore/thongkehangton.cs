...
namespace Kho_Adamstore
{
    public partial class thongkehangton : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "select Mahang,TenHang,MaLoai,SoLuong,sum(SoLuong* DonGia) as thanhtien from Hang  WHERE TenHang like '%" + timkiem + "%' group by MaHang,TenHang,MaLoai,SoLuong";
